...
const Sidebar = ({ children }) => {
  ...
  return (
    <div className={`sidebar-layout-unique ${collapsed ? 'sidebar-collapsed-unique' : ''}`}>
          ...
          <div className="sidebar-user-info-unique">
            ...
            {!collapsed && (
              <div className="sidebar-user-details-unique">
                <span className="sidebar-user-name-unique">{user?.email || 'Admin'}</span>
